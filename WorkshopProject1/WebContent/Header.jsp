...
<body>
	...
	<div class="containerh">
		...
		<td><span style="font-size: 50px; padding-left: 2px;color:#50c878; margin-left: 30px;">var</span></td>
		<td><span>&nbsp;&nbsp;</span></td>
		<td><span style="font-size: 50px;color: #0ae3e3;"> varshini</span> <br></td></tr>
		<tr></tr>		
		 </table>		
	</div>
